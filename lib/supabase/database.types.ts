...
isOneToOne: false
      ...
      referencedColumns: ["id"]
                  ...
                  Row: {
                    "actor_id": string | null,"after": Json | null,"before": Json | null,"booking_id": string | null,"created_at": string,"id": string,"tenant_id": string,"type": string
                  }
                  Insert: {
                    "actor_id"?: string | null,"after"?: Json | null,"before"?: Json | null,"booking_id"?: string | null,"created_at"?: string,"id"?: string,"tenant_id": string,"type": string
                  }
...
isOneToOne: false
      ...
      referencedColumns: ["id"]
                  ...
                  Row: {
                    "booked_by": string | null,"category_id": string,"conflict_occasion_id": string | null,"created_at": string,"ends_at": string,"id": string,"room_id": string,"starts_at": string,"status": string,"tenant_id": string,"title": string,"updated_at": string
                  }
                  Insert: {
                    "booked_by"?: string | null,"category_id": string,"conflict_occasion_id"?: string | null,"created_at"?: string,"ends_at": string,"id"?: string,"room_id": string,"starts_at": string,"status"?: string,"tenant_id": string,"title": string,"updated_at"?: string
                  }
...
isOneToOne: false
      ...
      referencedColumns: ["id"]
                  ...
                  Row: {
                    "active": boolean,"color": string,"id": string,"name": string,"sort_order": number,"tenant_id": string
                  }
                  Insert: {
                    "active"?: boolean,"color": string,"id"?: string,"name": string,"sort_order"?: number,"tenant_id": string
                  }
...
isOneToOne: false
      ...
      referencedColumns: ["id"]
                  ...
                  Row: {
                    "category": string | null,"dans_se_id": string,"dans_se_key": string | null,"id": string,"instructors": string | null,"name": string,"place": string | null,"removed_at": string | null,"schedule_text": string | null,"source_url": string | null,"synced_at": string,"tenant_id": string
                  }
                  Insert: {
                    "category"?: string | null,"dans_se_id": string,"dans_se_key"?: string | null,"id"?: string,"instructors"?: string | null,"name": string,"place"?: string | null,"removed_at"?: string | null,"schedule_text"?: string | null,"source_url"?: string | null,"synced_at"?: string,"tenant_id": string
                  }
...
isOneToOne: false
      ...
      referencedColumns: ["id"]
                  ...
                  Row: {
                    "course_id": string,"ends_at": string,"id": string,"starts_at": string,"tenant_id": string
                  }
                  Insert: {
                    "course_id": string,"ends_at": string,"id"?: string,"starts_at": string,"tenant_id": string
                  }
...
isOneToOne: false
      ...
      referencedColumns: ["id"]
                  ...
                  Row: {
                    "action": string,"actor_email": string | null,"actor_user_id": string | null,"created_at": string,"details": Json | null,"id": string,"tenant_id": string | null
                  }
                  Insert: {
                    "action": string,"actor_email"?: string | null,"actor_user_id"?: string | null,"created_at"?: string,"details"?: Json | null,"id"?: string,"tenant_id"?: string | null
                  }
...
isOneToOne: false
      ...
      referencedColumns: ["id"]
                  ...
                  Row: {
                    "active": boolean,"bg_gradient_from": string | null,"bg_gradient_to": string | null,"bg_gradient_via": string | null,"course_room_id": string | null,"created_at": string,"dans_se_last_sync_error": string | null,"dans_se_last_synced_at": string | null,"dans_se_org": string | null,"dans_se_token_enc": string | null,"id": string,"logo_path": string | null,"logo_url": string | null,"max_days_ahead": number,"name": string,"slug": string,"smtp_from_address": string | null,"smtp_from_name": string | null,"smtp_host": string | null,"smtp_password_enc": string | null,"smtp_port": number | null,"smtp_security": string | null,"smtp_test_at": string | null,"smtp_test_error": string | null,"smtp_test_ok": boolean,"smtp_user": string | null,"theme": Json | null,"timezone": string
                  }
                  Insert: {
                    "active"?: boolean,"bg_gradient_from"?: string | null,"bg_gradient_to"?: string | null,"bg_gradient_via"?: string | null,"course_room_id"?: string | null,"created_at"?: string,"dans_se_last_sync_error"?: string | null,"dans_se_last_synced_at"?: string | null,"dans_se_org"?: string | null,"dans_se_token_enc"?: string | null,"id"?: string,"logo_path"?: string | null,"logo_url"?: string | null,"max_days_ahead"?: number,"name": string,"slug": string,"smtp_from_address"?: string | null,"smtp_from_name"?: string | null,"smtp_host"?: string | null,"smtp_password_enc"?: string | null,"smtp_port"?: number | null,"smtp_security"?: string | null,"smtp_test_at"?: string | null,"smtp_test_error"?: string | null,"smtp_test_ok"?: boolean,"smtp_user"?: string | null,"theme"?: Json | null,"timezone"?: string
                  }
...
isOneToOne: false
      ...
      referencedColumns: ["id"]
          ...
          Views: {
            "tenant_smtp_status": {
                  Row: {
                    "dans_se_last_sync_error": string | null,"dans_se_last_synced_at": string | null,"dans_se_org": string | null,"dans_se_token_set": boolean | null,"id": string | null,"slug": string | null,"smtp_from_address": string | null,"smtp_from_name": string | null,"smtp_host": string | null,"smtp_password_set": boolean | null,"smtp_port": number | null,"smtp_security": string | null,"smtp_test_at": string | null,"smtp_test_error": string | null,"smtp_test_ok": boolean | null,"smtp_user": string | null
                  }
                  Insert: {
                           "dans_se_last_sync_error"?: string | null,"dans_se_last_synced_at"?: string | null,"dans_se_org"?: string | null,"dans_se_token_set"?: never,"id"?: string | null,"slug"?: string | null,"smtp_from_address"?: string | null,"smtp_from_name"?: string | null,"smtp_host"?: string | null,"smtp_password_set"?: never,"smtp_port"?: number | null,"smtp_security"?: string | null,"smtp_test_at"?: string | null,"smtp_test_error"?: string | null,"smtp_test_ok"?: boolean | null,"smtp_user"?: string | null
                         }
                        Update: {
                           "dans_se_last_sync_error"?: string | null,"dans_se_last_synced_at"?: string | null,"dans_se_org"?: string | null,"dans_se_token_set"?: never,"id"?: string | null,"slug"?: string | null,"smtp_from_address"?: string | null,"smtp_from_name"?: string | null,"smtp_host"?: string | null,"smtp_password_set"?: never,"smtp_port"?: number | null,"smtp_security"?: string | null,"smtp_test_at"?: string | null,"smtp_test_error"?: string | null,"smtp_test_ok"?: boolean | null,"smtp_user"?: string | null
                         }
